...
test_deny_gke_cluster_nodes_default_service_account {
    input := {
        "resource": {
    ...
    t.error_count(deny_gke_cluster_nodes_default_service_account, 2) with input as input
}

test_allow_valid_gke_cluster_nodes_service_account {
    input := {
        "resource": {
            "google_container_cluster": {
                "valid": {
    ...
    t.no_errors(deny_gke_cluster_nodes_default_service_account) with input as input
}
